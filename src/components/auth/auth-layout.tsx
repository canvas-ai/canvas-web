...
export function AuthLayout({ children }: AuthLayoutProps) {
  return (
    <div className="flex min-h-screen w-full items-center justify-center p-4 flex-col">
      <Card className="flex w-[95vw] h-[90vh] overflow-hidden">
      ...
      <a href="https://github.com/canvas-ai" target="_blank" className="mt-4 text-gray-600 hover:text-gray-900 flex items-center space-x-2" rel="noopener noreferrer">
